...
<?php 
        ...
        $q = "SELECT `post_id`,`username`,`kanji_char`,`kanji_desc`,`post-created-on`  FROM `posts` WHERE username='{$_SESSION["username"]}'";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class=\"fr-post group\">";
                 ...
                 echo " <div class=\"opt-bar\">";
                  ...
                  //echo "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;";
                  echo "    <a href=\"edit-post.php?id={$row["post_id"]}\" style=\" align-contents=\"center\"\"><button class=\"\">+ Edit Your Post</button></a>";
